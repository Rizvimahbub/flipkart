        ...
        <div className='second-nav-container pr-12 shadow-black h-[41px] min-w-[1500px] border-b border-[#D1D3D5]'>
            <div className=' cursor-pointer second-sub-nav max-w-[1248px] flex items-center w-5/6 mx-auto h-[40px]'>
                <div className='div-1 grow relative group'>
                    <p className='text-sm nav-p group-hover:text-[#1e70f3] text-[#212121] h-[41px] flex items-center justify-center font-semibold'>Electronics <FontAwesomeIcon className='second-nav-text-icon duration-100 text-[#b2b2b2] ml-1 w-[9px]' icon={faChevronDown} /></p>
                ...
                <div className=' div-1 grow relative group'>
                    <p className='text-sm nav-p group-hover:text-[#1e70f3] text-[#212121] h-[41px] flex items-center justify-center font-semibold'>TVs & Appliances <FontAwesomeIcon className='second-nav-text-icon duration-100 text-[#b2b2b2] ml-1 w-[9px]' icon={faChevronDown} /></p>
                ...
                <div className=' div-1 grow relative group'>
                    <p className='text-sm nav-p group-hover:text-[#1e70f3] text-[#212121] h-[41px] flex items-center justify-center font-semibold'>Men <FontAwesomeIcon className='second-nav-text-icon duration-100 text-[#b2b2b2] ml-1 w-[9px]' icon={faChevronDown} /></p>
                ...
                <div className=' div-1 grow relative group'>
                    <p className='text-sm nav-p group-hover:text-[#1e70f3] text-[#212121] h-[41px] flex items-center justify-center font-semibold'>Women <FontAwesomeIcon className='second-nav-text-icon duration-100 text-[#b2b2b2] ml-1 w-[9px]' icon={faChevronDown} /></p>
                ...
                <div className=' div-1 grow relative group'>
                    <p className='flex items-center justify-center text-sm nav-p group-hover:text-[#1e70f3] text-[#212121] h-[41px] font-semibold'>Baby & Kids <FontAwesomeIcon className='second-nav-text-icon duration-100 text-[#b2b2b2] ml-1 w-[9px]' icon={faChevronDown} /></p>
                ...
                <div className=' div-1 grow relative group'>
                    <p className='flex items-center justify-center text-sm nav-p group-hover:text-[#1e70f3] text-[#212121] h-[41px] font-semibold'>Sports, Books & More <FontAwesomeIcon className='second-nav-text-icon group-hover:(text-[#1e70f3] rotate-[-180deg]) duration-100 text-[#b2b2b2] ml-1 w-[9px]' icon={faChevronDown} /></p>
